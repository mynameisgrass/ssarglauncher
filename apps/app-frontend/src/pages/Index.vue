...
<template>
	<div class="p-6 flex flex-col gap-4">
		<div class="flex items-center gap-4 p-5 rounded-2xl bg-gradient-to-r from-emerald-900/40 via-green-900/30 to-transparent border border-emerald-500/20 shadow-xl">
			<img src="@/assets/biginctrans.png" alt="GRASSINC Logo" class="h-16 w-auto object-contain select-none shrink-0" />
			<div class="flex flex-col">
				<h1 v-if="recentInstances?.length > 0" class="m-0 text-3xl font-black text-contrast tracking-tight">Welcome back!</h1>
				<h1 v-else class="m-0 text-3xl font-black text-contrast tracking-tight">Welcome to GRASSINC!</h1>
				<p class="m-0 text-sm text-text-muted mt-1 font-medium">Your fast, lightweight Minecraft launcher & mod manager.</p>
			</div>
		</div>
