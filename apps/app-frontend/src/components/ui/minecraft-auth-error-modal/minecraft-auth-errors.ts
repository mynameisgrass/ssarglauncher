...
export const minecraftAuthErrors: MinecraftAuthError[] = [
	{
		...
		whatHappened:
			'Your saved Microsoft sign-in token has expired or was revoked, so Ssarg Launcher cannot refresh your Minecraft session.',
		stepsToFix: [
			'Sign out of the affected Minecraft account in Ssarg Launcher',
	...
	},
	{
		...
		stepsToFix: [
			...
			'Restart Ssarg Launcher after waiting',
	...
	},
	{
		...
		whatHappened:
			"Minecraft's authentication service is returning a server error, so Ssarg Launcher cannot finish signing you in right now.",
		stepsToFix: [
	...
	},
	{
		...
		stepsToFix: [
			...
			'Try signing in to Ssarg Launcher again',
		],
	},
	{
		matches: (message) =>
		...
		whatHappened:
			'Ssarg Launcher could not connect to a Microsoft, Xbox, or Minecraft service needed for sign-in. This is usually caused by a local network, DNS, proxy, firewall, hosts file, VPN, or antivirus issue.',
		stepsToFix: [
			'Restart Ssarg Launcher and try signing in again',
			'Check that your internet connection is working',
			'Allow Ssarg Launcher through your firewall, antivirus, proxy, VPN, and hosts file rules',
	...
	},
	{
		...
		whatHappened:
			'Xbox services rejected the request to authorize this account for Minecraft services, but did not return a specific account restriction that Ssarg Launcher recognizes.',
		stepsToFix: [
			'Sign in with the <a href="https://www.minecraft.net/en-us/download">official Minecraft Launcher</a>',
