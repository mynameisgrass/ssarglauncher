		...
		<div v-if="!doneLoading" class="splash-screen dark">
			<div class="app-logo-wrapper" data-tauri-drag-region>
				<div class="flex items-center gap-4 mb-3">
					<img src="@/assets/biginctrans.png" alt="GRASSINC" class="h-20 w-auto object-contain select-none" />
					<span class="text-4xl font-black text-contrast tracking-wider">GRASSINC</span>
				</div>
