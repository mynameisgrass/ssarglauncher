...
const messages = defineMessages({
	surveyTitle: {
		id: 'app.survey.title',
		defaultMessage: 'Hey there Ssarg Launcher user!',
	},
	surveyBody: {
		id: 'app.survey.body',
		defaultMessage:
			'Would you mind answering a few questions about your experience with Ssarg Launcher?',
	},
	surveyFooter: {
		id: 'app.survey.footer',
		defaultMessage:
			'This feedback will go directly to the Ssarg Launcher team and help guide future updates!',
	},
	takeSurvey: {
