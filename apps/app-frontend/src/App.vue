...
const messages = defineMessages({
	...
	modrinthAccount: {
		...
		defaultMessage: 'GrassLauncher account',
	},
	signedInAs: {
	...
	signInToModrinthAccount: {
		...
		defaultMessage: 'Sign in to a GrassLauncher account',
	},
	restarting: {
		id: 'app.restarting',
...
const updatePopupMessages = defineMessages({
	...
	meteredBody: {
		...
		defaultMessage: `Ssarg Launcher v{version} is available now! Since you're on a metered network, we didn't automatically download it.`,
	},
	downloadedBody: {
		id: 'app.update-popup.body.download-complete',
		defaultMessage: `Ssarg Launcher v{version} has finished downloading. Reload to update now, or automatically when you close Ssarg Launcher.`,
	},
	linuxBody: {
		id: 'app.update-popup.body.linux',
		defaultMessage:
			'Ssarg Launcher v{version} is available. Use your package manager to update for the latest features and fixes!',
	},
	reload: {
	...
	>
		...
		<div data-tauri-drag-region class="app-grid-statusbar bg-bg-raised h-[--top-bar-height] flex">
			<div data-tauri-drag-region class="flex min-w-0 flex-1 items-center overflow-hidden p-2">
				<div class="h-7 flex items-center gap-2 px-2 select-none pointer-events-none">
					<img src="@/assets/smallicontrans.png" alt="GRASSINC" class="h-6 w-auto object-contain" />
					<span class="text-emerald-400 font-black text-lg tracking-wider">GRASSINC</span>
				</div>
			...
			>
				...
				<div class="sidebar-default-content" :class="{ 'sidebar-enabled': sidebarVisible }">
					...
					<div class="p-4 flex flex-col gap-3">
						<div class="p-3.5 bg-card-bg/60 rounded-xl border border-border flex flex-col gap-1.5 text-left shadow-sm">
							<div class="flex items-center gap-1.5 text-xs font-bold text-primary">
								<span>❤️ Credits & Thanks</span>
							</div>
							<p class="text-xs text-text-muted m-0 leading-relaxed">
								Thanks to Modrinth for the open-source GUI, Microsoft authentication implementation, and public search API.
							</p>
						</div>
					</div>
				</div>
